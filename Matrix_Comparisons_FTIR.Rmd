...
Fig2 <-  Raman_FTIR %>%
   ...
   geom_text(aes(y = ifelse(label_y < .98, label_y, 1.03), label = n), size = 7)+
   facet_wrap(~sampletype_f, ncol = 4)+
   ...
   scale_y_continuous(labels = scales::percent, expand = c(0,0), limits = c(0,1.07))+
   labs(x = 'Method', y = "Particles Identified", alpha = "Identification") +
