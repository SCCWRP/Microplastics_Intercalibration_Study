---
title: "Microplastics Intercalibration Study Data Analysis: Matrix Comparisons, Raman"
...
```{r Raman Results, echo = FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE}
...
Results_Spike_Raman <- Results_Clean %>%
  ...
  filter(qa_fp != "ns")%>% 
  #Add a new column for unique combinations of particle characteristics
  mutate(size_color_morph = paste(sizefraction_f, color_f, morphology_f)) %>% 
  mutate(color_morph = paste(color_f, morphology_f))
...
Results_Spike_Raman_Plastic <- Results_Spike_Raman %>% 
  filter(qa_fp != "y")

#Create data frame for plastic particles only
Results_Spike_Raman_FP <- Results_Spike_Raman %>% 
  filter(qa_fp == "y")
...
# Types of Particles Analyzed by Raman

```{r echo = FALSE, results = 'hide', error = FALSE, warning = FALSE, message = FALSE, fig.height= 7, fig.width= 11}

#Size Fraction
size <-  Results_Spike_Raman %>%
   group_by(sampletype_f) %>%
...
size_plot <-  size %>%
   ...
   labs(title = "Particles Analyzed via Raman", caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman. Data labels represent the number of particles analyzed.")

size_plot

#Color
color <-  Results_Spike_Raman %>%
   group_by(sampletype_f) %>%
   count(color_f) %>% 
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>% 
...
#Morphology
morphology <-  Results_Spike_Raman %>%
   group_by(sampletype_f) %>%
   count(morphology_f) %>% 
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>% 
...
morphology_plot <-  morphology %>%
   ...
   theme(axis.text=element_text(size=15),
         axis.title=element_text(size=14,face="bold")) +
   scale_fill_manual(values = cal_palette("kelp1")) +
   labs(title = "Particles Analyzed via Raman")
...
Accuracy_All_Spike <-  Results_Spike_Raman %>%
...
Raman_Accuracy_Spike <-  Accuracy_All_Spike %>%
   ...
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   scale_x_discrete(labels=c("y" = "False Positive", "n" = "Plastic")) + 
   labs(title = "Overall Accuracy, Raman", caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman. Data labels represent the number of particles analyzed.")

Raman_Accuracy_Spike
...
kable(a, digits = 2, caption = "Overall Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")

# Overall accuracy per lab
Accuracy_Lab <-  Results_Spike_Raman %>%
...
kable(b, digits = 2, caption = "Overall Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
Raman_Accuracy_Spike <-  Accuracy_All_Spike %>%
   ...
   theme(axis.text=element_text(size = 8),
         axis.title=element_text(size=14,face="bold")) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Size Fraction Accuracy, Raman", caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman. Data labels represent the number of particles analyzed.")
...
kable(a, digits = 2, caption = "Size Fraction Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")

#Histogram of measured particle size and accuracy
Accuracy_Measured_Size <- Results_Spike_Raman %>%
   filter(!length == -88) %>%
   ...
   theme(axis.text=element_text(size=15),
         axis.title=element_text(size=14,face="bold")) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Measured Size (Length) Accuracy, Raman", caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman.", y = "Number of Particles", x = "Measured Particle Length (µm)", fill = "Chemcial ID Result")
...
By_Lab <-  Accuracy_Lab %>%
   ...
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Size Fraction Accuracy, Raman", 
        subtitle = paste(df2$sizefraction_f[[i]]), 
        caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman. Data labels represent the number of particles analyzed.")
...
kable(b, digits = 2, caption = "Size Fraction Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
FigS10 <- Results_Spike_Raman %>%
   ...
   mutate(correct = case_when(correct == "TRUE" ~ "Correct",
                             correct == "FALSE" ~ "Incorrect")) %>% 
   ggplot(aes(x = length, alpha = correct, fill = sampletype_f))+
   geom_histogram(bins = 75, color = "gray40") +
   facet_wrap(~sampletype_f)+
   scale_x_log10() +
   ...
   scale_fill_manual(values = c("royalblue", "forestgreen", "darksalmon", "goldenrod4"), guide = "none") +
   labs(title = "Raman", y = "Number of Particles", x = "Measured Particle Length (µm)", alpha = "Identification")+
...
Raman_Accuracy_Spike <-  Accuracy_All_Spike %>%
   ...
   theme(axis.text=element_text(size = 8),
         axis.title=element_text(size=14,face="bold")) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Color Accuracy, Raman", caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman. Data labels represent the number of particles analyzed.")
...
kable(a, digits = 2, caption = "Color Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
By_Lab <-  Accuracy_Lab %>%
   ...
   theme(axis.text=element_text(size=8),
         ...
         plot.subtitle=element_text(size=14)) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Color Accuracy, Raman", 
...
kable(b, digits = 2, caption = "Color Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
Raman_Accuracy_Spike <-  Accuracy_All_Spike %>%
   ...
   theme(axis.text=element_text(size = 8),
         axis.title=element_text(size=14,face="bold")) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Morphology Accuracy, Raman", caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman. Data labels represent the number of particles analyzed.")
...
kable(a, digits = 2, caption = "Morphology Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
By_Lab <-  Accuracy_Lab %>%
   ...
   theme(axis.text=element_text(size=8),
         ...
         plot.subtitle=element_text(size=14)) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Morphology Accuracy, Raman", 
...
kable(b, digits = 2, caption = "Morphology Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
Raman_Accuracy_Spike <-  Accuracy_All_Spike %>%
   ...
   theme(axis.text=element_text(size = 8),
         axis.title=element_text(size=14,face="bold")) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Material Type Accuracy, Raman", caption = "Results are for spiked plastic and false positive particles that where chemically identified using Raman. Data labels represent the number of particles analyzed.")
...
kable(a, digits = 2, caption = "Material Type Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
By_Lab <-  Accuracy_Lab %>%
   ...
   theme(axis.text=element_text(size=8),
         ...
         plot.subtitle=element_text(size=14)) +
   scale_fill_manual(values = c("darkmagenta", "orchid")) +
   labs(title = "Material Type Accuracy, Raman", 
...
kable(b, digits = 2, caption = "Material Type Accuracy, Raman") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>%
  scroll_box(width = "700px", height = "200px")
...
# Overall Accuracy
Results_Raman_Accuracy <-  Results_Spike_Raman_Plastic %>%
   group_by(sampletype_f) %>% 
   count(qa_correctchemid_raman == "y") %>%
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>% 
...
# Accuracy for spiked plastics and FPs (qa_fp = NA are results for plastic)
Accuracy_All_Spike <-  Results_Spike_Raman_Plastic %>%
   group_by(qa_fp, sampletype_f) %>%
   count(qa_correctchemid_raman == "y") %>%
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>%   
...
# Overall accuracy per lab
Accuracy_Lab <-  Results_Spike_Raman_Plastic %>%
   group_by(sampletype_f, labid) %>%
   count(qa_correctchemid_raman == "y") %>%
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>%   
...
#Histogram of measured particle size and accuracy
Accuracy_Measured_Size <- Results_Spike_Raman_Plastic %>%
   filter(!length == -88) %>%
   mutate(length = length*1000) %>% 
   group_by(sampletype_f, length) %>% 
   count(qa_correctchemid_raman == "y") %>%
...
# Overall Accuracy
Results_Raman_Accuracy <-  Results_Spike_Raman_FP %>%
   group_by(sampletype_f) %>% 
   count(qa_correctchemid_raman == "y") %>%
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>% 
...
# Accuracy for spiked plastics and FPs (qa_fp = NA are results for plastic)
Accuracy_All_Spike <-  Results_Spike_Raman_FP %>%
   group_by(qa_fp, sampletype_f) %>%
   count(qa_correctchemid_raman == "y") %>%
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>%   
...
# Overall accuracy per lab
Accuracy_Lab <-  Results_Spike_Raman_FP %>%
   group_by(sampletype_f, labid) %>%
   count(qa_correctchemid_raman == "y") %>%
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>%   
...
#Histogram of measured particle size and accuracy
Accuracy_Measured_Size <- Results_Spike_Raman_FP %>%
   filter(!length == -88) %>%
   mutate(length = length*1000) %>% 
   group_by(sampletype_f, length) %>% 
   count(qa_correctchemid_raman == "y") %>%
...
Incorrect_IDs <- Results_Clean %>%
  ...
  filter(qa_correctchemid_raman %in% c("n", "u"))
...
a <-  Incorrect_IDs %>%
   ...
   filter(morphology_f == df$morphology_f[[i]]) %>%
   filter(polymer_f == df$polymer_f[[i]]) %>%
   group_by(sampletype_f, labid, raman_chemicalid, polymer_f) %>%
   count(qa_correctchemid_raman == "y") %>%
   mutate(prop = prop.table(n)) %>% 
   as.data.frame() %>%   
   rename("correct" = `qa_correctchemid_raman == "y"`) %>% 
...
# Table for accuracy results for both plastic and false positives per lab
table <- a %>%
  select(sampletype_f, labid, raman_chemicalid, polymer_f, correct, n, prop) %>% 
  rename("Matrix" = sampletype_f, "Lab ID" = labid, "Reported Chemical ID" = raman_chemicalid, "True Chemical ID" = polymer_f, "Chemical ID Result" = correct, "Number of Particles" = n, "Proportion" = prop)
